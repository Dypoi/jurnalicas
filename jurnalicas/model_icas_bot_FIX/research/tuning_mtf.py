...
VARIANTS = {
    ...
    # ---- [REV 2.3 — SCALPING] sinyal choch (frekuensi live ~95/bln), geometri scalp.
    # Diagnosis n=1234: 71% trade mencapai +50 pips, 53% LOSER sempat +25 pips
    # sebelum jebol; TP1 187.5 hanya 26%; TP2/TP3 5%/1% (dead weight); winner
    # tahan SL150 (hanya 1.3% winner sempat -150). -> dekatkan TP, SL tetap. ----
    "S1":  ("SCALP TP 50/100 (50/50), SL 150",
             {"signal_mode": "choch", "tp1_pips": 50.0, "tp2_pips": 100.0, "r1": 0.50, "r2": 0.50, "r3": 0.0}),
    "S2":  ("SCALP TP 75/150 (50/50), SL 150",
             {"signal_mode": "choch", "tp1_pips": 75.0, "tp2_pips": 150.0, "r1": 0.50, "r2": 0.50, "r3": 0.0}),
    "S3":  ("SCALP TP 50/100 (60/40), SL 150",
             {"signal_mode": "choch", "tp1_pips": 50.0, "tp2_pips": 100.0, "r1": 0.60, "r2": 0.40, "r3": 0.0}),
    "S4":  ("SCALP TP 50/100 (50/50), SL 100",
             {"signal_mode": "choch", "tp1_pips": 50.0, "tp2_pips": 100.0, "r1": 0.50, "r2": 0.50, "r3": 0.0,
              "sl_pips": 100.0}),
    "S5":  ("SCALP TP 75/150 (50/50), SL 100",
             {"signal_mode": "choch", "tp1_pips": 75.0, "tp2_pips": 150.0, "r1": 0.50, "r2": 0.50, "r3": 0.0,
              "sl_pips": 100.0}),
    "S6":  ("SCALP TP 100/200 (50/50), SL 150",
             {"signal_mode": "choch", "tp1_pips": 100.0, "tp2_pips": 200.0, "r1": 0.50, "r2": 0.50, "r3": 0.0}),
    "S7":  ("SCALP TP1 50 (70%) + runner trail 30%, SL 150",
             {"signal_mode": "choch", "tp1_pips": 50.0, "tp2_pips": 10000.0, "tp3_pips": 10000.0,
              "r1": 0.70, "r2": 0.15, "r3": 0.15}),
    "S8":  ("SCALP ultra TP 25/75 (50/50), SL 150",
             {"signal_mode": "choch", "tp1_pips": 25.0, "tp2_pips": 75.0, "r1": 0.50, "r2": 0.50, "r3": 0.0}),
    "S9":  ("SCALP TP 50/100 + trail cepat 50/30, SL 150",
             {"signal_mode": "choch", "tp1_pips": 50.0, "tp2_pips": 100.0, "r1": 0.50, "r2": 0.50, "r3": 0.0,
              "trail_step_pips": 50.0}),
    "S10": ("SCALP S1 + filter tren SMA200-harian",
             {"tp1_pips": 50.0, "tp2_pips": 100.0, "r1": 0.50, "r2": 0.50, "r3": 0.0,
              "trend_filter": "sma200d"}),
    "S11": ("SCALP S5 + filter tren SMA200-harian",
             {"tp1_pips": 75.0, "tp2_pips": 150.0, "r1": 0.50, "r2": 0.50, "r3": 0.0,
              "sl_pips": 100.0, "trend_filter": "sma200d"}),
    # ---- [REV 2.3b] sinyal MTF W24h (frekuensi ~66/bln, PF 1.15) x geometri moderat ----
    "G1":  ("W24h + TP 100/200 (50/50) 2-tier",
             {"signal_mode": "mtf", "mtf_m30_mode": "pd", "mtf_sweep_bars": 288,
              "tp1_pips": 100.0, "tp2_pips": 200.0, "r1": 0.50, "r2": 0.50, "r3": 0.0}),
    "G2":  ("W24h + TP 125/250 (50/50) 2-tier",
             {"signal_mode": "mtf", "mtf_m30_mode": "pd", "mtf_sweep_bars": 288,
              "tp1_pips": 125.0, "tp2_pips": 250.0, "r1": 0.50, "r2": 0.50, "r3": 0.0}),
    "G3":  ("W24h + TP 50/100 (50/50) scalp",
             {"signal_mode": "mtf", "mtf_m30_mode": "pd", "mtf_sweep_bars": 288,
              "tp1_pips": 50.0, "tp2_pips": 100.0, "r1": 0.50, "r2": 0.50, "r3": 0.0}),
    "G4":  ("W24h + trail cepat 50/30 (TP plan)",
             {"signal_mode": "mtf", "mtf_m30_mode": "pd", "mtf_sweep_bars": 288, "trail_step_pips": 50.0}),
    "G5":  ("V8T + TP 100/200 (50/50) 2-tier",
             {"signal_mode": "mtf", "mtf_m30_mode": "pd", "mtf_sweep_bars": 48, "trend_filter": "sma200d",
              "tp1_pips": 100.0, "tp2_pips": 200.0, "r1": 0.50, "r2": 0.50, "r3": 0.0}),
    "G6":  ("W24h + SMA200-harian (TP plan)",
             {"signal_mode": "mtf", "mtf_m30_mode": "pd", "mtf_sweep_bars": 288, "trend_filter": "sma200d"}),
}
